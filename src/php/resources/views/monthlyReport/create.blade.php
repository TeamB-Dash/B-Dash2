							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									...
									<select name="target_month" class="form-control" id="target_month">
										...
										<option value="2023-05-01" @if( old('target_month') == '2023-05-01') selected @endif>2023年05月</option>
										<option value="2023-04-01" @if( old('target_month') == '2023-04-01') selected @endif>2023年04月</option>
										<option value="2023-03-01" @if( old('target_month') == '2023-03-01') selected @endif>2023年03月</option>
										<option value="2023-02-01" @if( old('target_month') == '2023-02-01') selected @endif>2023年02月</option>
										<option value="2023-01-01" @if( old('target_month') == '2023-01-01') selected @endif>2023年01月</option>
										<option value="2022-12-01" @if( old('target_month') == '2022-12-01') selected @endif>2022年12月</option>
										<option value="2022-11-01" @if( old('target_month') == '2022-11-01') selected @endif>2022年11月</option>
										<option value="2022-10-01" @if( old('target_month') == '2022-10-01') selected @endif>2022年10月</option>
										<option value="2022-09-01" @if( old('target_month') == '2022-09-01') selected @endif>2022年09月</option>
										<option value="2022-08-01" @if( old('target_month') == '2022-08-01') selected @endif>2022年08月</option>
										<option value="2022-07-01" @if( old('target_month') == '2022-07-01') selected @endif>2022年07月</option>
									</select>
								</div>
							</div>
						{{-- </form> --}}
										...
										<div class="markdown-editor">
											<div class="tab-content markdown-content">
												<div class="tab-pane active" id="project_summary-write">
													<textarea rows="15" class="form-control" placeholder="例）# 英語学習アプリ開発" name="project_summary" id="project_summary">{{ old('project_summary') }}</textarea>
