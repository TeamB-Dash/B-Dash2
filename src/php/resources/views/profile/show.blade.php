            ...
            <div class="mt-6 space-y-6">
                ...
                <div>
                    ...
                    <div id="department_id" name="department_id" type="text" class="mt-1 block w-full" required
                        autofocus autocomplete="department_id">{{ $department->name }}</div>
                ...
                <div>
                    ...
                    <div id="email" name="email" type="email" class="mt-1 block w-full" required autofocus
                        autocomplete="email">{{ $user->email }}</div>
                ...
                <div>
                    ...
                    <div id="gender" name="gender" type="text" class="mt-1 block w-full" required autofocus
                        autocomplete="gender">{{ $gender }}</div>
                    <x-input-error class="mt-2" :messages="$errors->get('gender')" />
                </div>

                <div>
                    <x-input-label for="blood_type" :value="__('血液型')" />
                    <div id="blood_type" name="blood_type" type="text" class="mt-1 block w-full" required autofocus
                        autocomplete="blood_type">{{ $blood_type }}</div>
