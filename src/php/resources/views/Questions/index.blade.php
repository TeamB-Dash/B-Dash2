          ...
          <div class="flex flex-wrap -m-12">
            <div class="p-12 md:w-1/2 flex flex-col items-start">
                ...
                <span class="flex-grow flex flex-col pl-4">
                    <span class="title-font font-medium text-gray-900">{{ $user->name }}</span>
                    <span class="text-gray-400 text-xs tracking-widest mt-0.5">投稿日時</span>
                </span>
                </a>
              <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY1</span>
              <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY2</span>
              <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY3</span>
              <span class="inline-block py-1 px-2 rounded bg-indigo-50 text-indigo-500 text-xs font-medium tracking-widest">CATEGORY4</span>
              ...
              <h2 class="sm:text-3xl text-2xl title-font font-medium text-gray-900 mt-4 mb-4">投稿したQ&Aのタイトルをここに表示する</h2>
              <p class="leading-relaxed mb-8">投稿したQ&Aのコンテンツをここに表示する。投稿したQ&Aのコンテンツをここに表示する。投稿したQ&Aのコンテンツをここに表示する。投稿したQ&Aのコンテンツをここに表示する。</p>
            </div>
